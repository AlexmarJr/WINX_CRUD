...
class ProductRepository
{
    ...
    public function paginateForTenancy(string $tenancyId, ?string $search, ?ProductStatus $status, ?string $categoryId, ?string $minPrice, ?string $maxPrice, int $perPage, string $sortBy, string $sortDir): LengthAwarePaginator
    {
        $query = Product::query()
            ->select('products.*')
            ->with('category')
